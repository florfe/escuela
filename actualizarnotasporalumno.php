...
require_once 'funciones/actualizarnotasporalumno.php'; 
}
...
<div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Cargar Notas Primera Etapa</h3>
    ...
    <th>E8</th><th>R1</th> <th>R2</th> 
     ...
     <th>R1</th><th>D</th><th>F</th><th></th>
                  </tr>
                </thead>
...
function getStudents() {
	var selectedCourse = document.getElementById('curso').value;
        ...
        $.ajax({
    	type: 'POST',
      url: 'get_students20.php', // Replace with the actual URL to fetch students
