...
require_once 'funciones/insertar_alumnos.php'; 
require_once 'funciones/insertar_dni.php'; 
$Mensaje= '';
$Estilo= 'danger';
if(!empty($_POST['BotonRegistrar'])) {
$dni = $_POST['NumeroDni'];
    $checkIfExistsQuery = "SELECT * FROM alumnos WHERE NumeroDni = '$dni'";
...
if(empty($Mensaje)){
  if(InsertarAlumnos($MiConexion)!= false ) {
 ...
 ?>
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Registrar Alumnos</h1>
          <p>Completa todos los datos</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="principalalumnos.php">Inicio</a></li>
          <li class="breadcrumb-item"><a href="cargaalumnos.php">Registro</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Ingresa los datos personales<img  src= "icon/stick-figure-holding-pencil-pr-unscreen.gif" style="width:25%; position: absolute; right:3%" /></h3>
      ...
      <!-- RENGLON UNO  APELLIDO  Y NOMBRE--><div class="form-group row">
    <div class="col-sm-6 mb-3 mb-sm-0">
        <label class="control-label">Fecha Inscripcion </label> 
        <input type="text" class="form-control form-control-user" id="fechaInscripcion" name="FechaInscripcion">
    </div>
</div>
 ...
 <!-- RENGLON CUATRO EDAD Y FECHA NAC -->
      <div class="form-group row">
      <div class="col-sm-6 "><label class="control-label">Fecha de Nacimiento </label> 
      <i class="fa fa-asterisk" aria-hidden="true"></i>
...
<?php } ?>
 ...
 <div class="tile-footer">
    <button class="btn btn-primary" type="submit" name="BotonRegistrar" value="registrar"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="cargaalumnos.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
            </div>
            </div>
            </form>
          </div>
  ...
  <script>
    ...
    // Establecer la fecha formateada en el campo de entrada
    document.getElementById('fechaInscripcion').value = fechaFormateada;
</script>
