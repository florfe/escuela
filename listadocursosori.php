...
$SQL = "SELECT doc.Id, doc.Apellido, doc.Nombre, mat.Docente, mat.IdCurso as Curso, mat.IdTurno as Turno, mat.IdDivision as Division, mat.Nombre as Materia
        FROM docentes doc, materiasorientado mat
        WHERE doc.Id = mat.Docente
        ORDER BY mat.IdCurso";
...
?>
  ...
  #docentesTable thead {
    background-color: rgba(230, 126, 34, 0.5); /* Change the background color of the header */
...
<?php require_once 'user.inc.php'; ?>
      ...
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Listados</h1>
                   <p>Listado total de docentes por cursos</p>
           </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Listado</li>
          <li class="breadcrumb-item active">
            <a href="#">Listado total de docentes por cursos</a></li>
          </ul>
      </div>
      <div class="row">
                <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Docentes de Ciclo Básico por curso</h3>
              ...
              <table id="docentesTable" class="table">
                ...
                <td><?php echo $row['Turno']; ?></td>
                   <td><?php echo $row['Materia']; ?></td>
                               <td><a href="actualizarcursosCO.php?id=<?php echo $row['Id']; ?>">Actualizar datos...</a></td>
                  </tr>
                  <?php } ?>
 ...
 <h4> Total: <?php echo ($row_cnt);?></h4>
        ...
        <div class="clearfix"></div>
              ...
              <h3 class="tile-title">Cantidad de Docentes por Grupo de Cursos</h3>
  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        data: courseCounts,
       backgroundColor: 'rgba(230, 126, 34, 0.5)', // Change the background color
        borderColor: 'rgba(230, 126, 34, 1)', // Change the border color
        borderWidth: 1
      }]
    },
    options: {
