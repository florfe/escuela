...
$SQL = "SELECT DISTINCT  Id,  Nombre, IdCurso, IdDivision, IdTurno   
        FROM  materias Where IdCurso='1' ORDER BY IdCurso, IdDivision, IdTurno, Nombre 
        ";
$Mensaje= '';
$Estilo= 'danger';
  ...
  <?php require_once 'slidermaterias.php'; ?>
    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Materias 1° Año</h3>
...
<th></th><th></th>
            ...
            </div><img  src= "icon/dog-sitting-down-md-nwm-v2-unscreen.gif" style="width:15%; position: absolute; right: 8%" />
          </div>
        </div>
