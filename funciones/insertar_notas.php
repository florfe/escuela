...
$SQL_Insert = "INSERT INTO notas (IdAlumnos, Curso, Materias, Eval1Nota, Eval1Recup1, Eval1Recup2, Eval2Nota, Eval2Recup1, Eval2Recup2, Eval3Nota, Eval3Recup1, Eval3Recup2, Eval4Nota, Eval4Recup1, Eval4Recup2, Jis1Nota, Jis1Recup, Eval5Nota, Eval5Recup1, Eval5Recup2, 
    Eval6Nota, Eval6Recup1, Eval6Recup2, 
    Eval7Nota, Eval7Recup1, Eval7Recup2, 
    Eval8Nota, Eval8Recup1, Eval8Recup2, 
    Jis2Nota, Jis2Recup, ColoqDiciembre, ColoqFebrero) 
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
$stmt = mysqli_prepare($vConexion, $SQL_Insert);
if ($stmt) {
        mysqli_stmt_bind_param($stmt, 'sssssssssssssssssssssssssssssssss', $idAlumno, $curso, $materia, $eval1Nota, $eval1Recup1, $eval1Recup2, $eval2Nota, $eval2Recup1, $eval2Recup2, $eval3Nota, $eval3Recup1, $eval3Recup2, $eval4Nota, $eval4Recup1, $eval4Recup2, $jis1Nota, $jis1Recup, $eval5Nota, $eval5Recup1, $eval5Recup2, 
    $eval6Nota, $eval6Recup1, $eval6Recup2, 
    $eval7Nota, $eval7Recup1, $eval7Recup2, 
    $eval8Nota, $eval8Recup1, $eval8Recup2, 
    $jis2Nota, $jis2Recup, $coloqDiciembre, $coloqFebrero  );
