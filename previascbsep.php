...
require_once 'funciones/insertar_previasseptiembre.php'; 
 ...
 ?>
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Registrar Previas Ciclo Basico</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Ingresa los datos solicitados<img  src= "icon/stick-figure-power-clapping-an-unscreen.gif" style="width:18%; position: absolute; right:15%" /></h3>
...
<?php } ?>
      ...
      <i class="fa fa-asterisk" aria-hidden="true"></i>
      <input type="date" id="fecha" class="form-control form-control-user" name="Fecha" min="2023-09-01" max="2023-10-30">
      </div></div>
...
<?php } ?>
    ...
    <button class="btn btn-primary" type="submit" name="BotonRegistrar" value="registrar"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="previascbsep.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
            </div>
