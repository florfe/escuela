 ...
 ?>
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Registrar Coloquios Ciclo Orientado</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Ingresa los datos solicitados<img  src= "icon/figure-cheering-clapping-md-nw-unscreen.gif" style="width:18%; position: absolute; right:15%" /></h3>
...
<?php } ?>
    ...
    <button class="btn btn-primary" type="submit" name="BotonRegistrar" value="registrar"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="coloquioscodic.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
            </div>
