...
FROM coloquios as  col, docentes as  doc
  ...
  <?php require_once 'sliderexamen.php'; ?>
    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Coloquios Febrero</h3>
...
<form method="GET">
    ...
    <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <select class="form-control form-control-user" style="width: 20%" name="curso" id="curso" onchange="this.form.submit()">
                                ...
                                <?php
                                $coursesQuery = "SELECT DISTINCT Curso FROM coloquios";
...
<div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <select class="form-control form-control-user" style="width: 20%" name="division" id="division" onchange="this.form.submit()">
                                ...
                                $divisionsQuery = "SELECT DISTINCT Division FROM coloquios";
    ...
    <div class="col-sm-6 mb-3 mb-sm-0">
                        <label for="turno"class="control-label">Filtrar por Turno:</label>
                            <select class="form-control form-control-user" style="width: 20%" name="turno" id="turno" onchange="this.form.submit()">
                                ...
                                $turnosQuery = "SELECT DISTINCT Turno FROM coloquios";
 ...
 <label for="fecha" class="control-label">Filtrar por Fecha:</label>
  <input class="form-control form-control-user" style="width: 20%" type="date" name="fecha" id="fecha" value="<?php echo $selectedFecha; ?>" min="2023-02-01" max="2023-03-31" onchange="this.form.submit()">
                ...
                <?php
                 ...
                 while($row=mysqli_fetch_assoc($resultado))
                  ...
                  <td><?php echo $row['Curso']; ?></td>
                   ...
                   <td><a href="actualizarcoloquios.php?id=<?php echo $row['ID']; ?>">Actualizar datos...</a></td>
 ...
 <canvas id="myChart" width="800" height="600"></canvas>
          <?php
$chartQuery = "SELECT Fecha, COUNT(*) as cantidad FROM coloquios  GROUP BY Fecha";
