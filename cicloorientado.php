...
require_once 'funciones/insertar_materiasorientado.php'; 
...
$tur = $_POST['IdTurno'];
  $checkIfExistsQuery = "SELECT * FROM materiasorientado WHERE Nombre = '$mat' and IdCurso = '$cur' and IdDivision = '$div' and IdTurno = '$tur' ";
...
if(empty($Mensaje)){
  if(InsertarMateriasOrientado($MiConexion)!= false) {
 ...
 ?>
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Registrar Materias Ciclo Orientado</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Ingresa los datos solicitados<img  src= "icon/world-on-shoulders-md-nwm-v2-unscreen.gif" style="width:18%; position: absolute; right:15%" /></h3>
...
<?php } ?>
    ...
    <button class="btn btn-primary" type="submit" name="BotonRegistrar" value="registrar"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="cicloorientado.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
            </div>
