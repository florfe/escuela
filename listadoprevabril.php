...
FROM previasabril as col,  docentes  as doc 
...
<?php require_once 'user.inc.php'; ?>
  ...
  <?php require_once 'sliderexamen.php'; ?>
    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Previas Abril</h3>
    ...
    <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <select class="form-control form-control-user" style="width: 20%" name="curso" id="curso" onchange="this.form.submit()">
                                ...
                                <?php
                                $coursesQuery = "SELECT DISTINCT Curso FROM previasabril";
 ...
 <label for="fecha" class="control-label">Filtrar por Fecha:</label>
  <input class="form-control form-control-user" style="width: 20%" type="date" name="fecha" id="fecha" value="<?php echo $selectedFecha; ?>" min="2023-03-30" max="2023-06-01" onchange="this.form.submit()">
                      ...
                      <td><?php echo $row['Fecha']; ?></td>
                       <td><?php echo $row['Hora']; ?></td>
                        <!--<td><?php echo $row['Apellido']; ?><?php echo $row['Nombre']; ?></td>
                         <td><?php echo $row['Apellido']; ?><?php echo $row['Nombre']; ?></td>
                          <td><?php echo $row['Apellido']; ?><?php echo $row['Nombre']; ?></td>-->
                    <td><a href="actualizarpreviasabril.php?id=<?php echo $row['ID']; ?>">Actualizar datos...</a></td>
 ...
 <canvas id="myChart" width="800" height="600"></canvas>
          <?php
$chartQuery = "SELECT Fecha, COUNT(*) as cantidad FROM previasabril  GROUP BY Fecha";
