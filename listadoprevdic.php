...
FROM previasdiciembre as  col, docentes  as doc 
...
<?php require_once 'user.inc.php'; ?>
  ...
  <?php require_once 'sliderexamen.php'; ?>
    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Previas Diciembre</h3>
    ...
    <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <select class="form-control form-control-user" style="width: 20%" name="curso" id="curso" onchange="this.form.submit()">
                                ...
                                <?php
                                $coursesQuery = "SELECT DISTINCT Curso FROM previasdiciembre";
 ...
 <label for="fecha" class="control-label">Filtrar por Fecha:</label>
  <input class="form-control form-control-user" style="width: 20%" type="date" name="fecha" id="fecha" value="<?php echo $selectedFecha; ?>" min="2023-11-30" max="2023-12-31" onchange="this.form.submit()">
                ...
                <?php
                 ...
                 while($row=mysqli_fetch_assoc($resultado))
                  ...
                  <td><?php echo $row['Curso']; ?></td>
                    ...
                    <td><a href="actualizarpreviasdiciembre.php?id=<?php echo $row['ID']; ?>">Actualizar datos...</a></td>
 ...
 <h4> Total: <?php echo ($row_cnt);?></h4>
            ...
            </div><img  src= "icon/steaming-mad-ears-anim-md-nwm--unscreen.gif" style="width:15%; position: absolute; right: 8%" />
          </div>
        </div>
 ...
 <canvas id="myChart" width="800" height="600"></canvas>
          <?php
$chartQuery = "SELECT Fecha, COUNT(*) as cantidad FROM previasdiciembre  GROUP BY Fecha";
