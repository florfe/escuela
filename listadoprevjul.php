...
FROM previasjulio as  col, docentes  as doc 
...
<?php require_once 'user.inc.php'; ?>
  ...
  <?php require_once 'sliderexamen.php'; ?>
    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Previas Julio</h3>
    ...
    <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <select class="form-control form-control-user" style="width: 20%" name="curso" id="curso" onchange="this.form.submit()">
                                ...
                                <?php
                                $coursesQuery = "SELECT DISTINCT Curso FROM previasjulio";
                ...
                <?php
                 ...
                 while($row=mysqli_fetch_assoc($resultado))
                  ...
                  <td><?php echo $row['Curso']; ?></td>
                    ...
                    <td><a href="actualizarpreviasjulio.php?id=<?php echo $row['ID']; ?>">Actualizar datos...</a></td>
 ...
 <h4> Total: <?php echo ($row_cnt);?></h4>
            ...
            </div><img  src= "icon/turn-your-back-md-nwm-v2-unscreen.gif" style="width:15%; position: absolute; right: 8%" />
          </div>
        </div>
 ...
 <canvas id="myChart" width="800" height="600"></canvas>
          <?php
$chartQuery = "SELECT Fecha, COUNT(*) as cantidad FROM previasjulio  GROUP BY Fecha";
