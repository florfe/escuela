...
require_once 'funciones/listar_listacursobasico.php'; 
$ListadoCurso=Listar_Listacursosbasico($MiConexion);
...
$ListadoMaterias=Listar_Listamaterias($MiConexion);
$CantidadMaterias=count($ListadoMaterias);
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Ciclo Basico Turno Mañana<img  src= "icon/marching-sousaphone-player-md--unscreen.gif" style="width:10%; position: absolute; right:1%" /></h3>
...
if(!empty($_POST['Curso'])&& $_POST['Curso']==  $ListadoCurso[$i]['ID']){
  $selected='selected';}
    ...
    ?>
<option value="<?php echo $ListadoCurso[$i]['ID'];  ?>" <?php echo $selected; ?> ><?php echo $ListadoCurso[$i]['CURSO'], $ListadoCurso[$i]['DIVISION'], $ListadoCurso[$i]['TURNO']?></option>
<?php } ?>
</select> 
                    </div>
                    <div class="col-sm-6 mb-3 mb-sm-0">
