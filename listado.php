...
$docentes="SELECT doc.Id, doc.Nombre, doc.Apellido, doc.NumeroDni, doc.Cuil, doc.FechaNacimiento, doc.Edad, doc.NumeroTel
        FROM docentes doc";
...
<?php require_once 'user.inc.php'; ?>
              ...
              <table id="docentesTable" class="table">
                <thead>
                 ...
                 while($row=mysqli_fetch_assoc($resultado))
                  ...
                  <td><a href="actualizar.php?id=<?php echo $row['Id']; ?>">Actualizar datos...</a></td>
                  </tr>
                  <?php } ?>
 ...
 <h4> Total: <?php echo ($row_cnt);?></h4>
            ...
            </div><img  src= "icon/businessmen-team-high-five-md--unscreen.gif" style="width:15%; position: absolute; right:8%" />
          </div>
        </div>
        <div class="clearfix"></div>
              </div>
              <h3 class="tile-title">Cantidad Docentes por Edad</h3>
