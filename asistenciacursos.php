...
if(!empty($_POST['BotonRegistrar'])){
 ...
 require_once 'funciones/dni_loguinlibreton.php'; 
  ...
  if(!empty($AlumnoLogueado)){
     ...
     header('location:ReportesAsistencia-pdf-php/index.php');
      exit;
    }
    else
      {
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Ingresa el curso<img  src= "icon/figure-juggling-time-md-nwm-v2-unscreen.gif" style="width:15%; position: absolute; right: 8%" /></h3>
...
<?php } ?>
   ...
   <div class="tile-footer">
    ...
    <button class="btn btn-primary" type="submit" name="BotonRegistrar" value="registrar"><i class="fa fa-fw fa-lg fa-check-circle"></i>Generar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="asistenciacursos.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
            </div>
            </div>
            </form>
