...
$coloquios = "SELECT col.Id as ID, col.Curso, col.Division, col.Turno, col.Materia, col.Fecha, col.Hora, col.Docente, doc.Id, doc.Apellido, doc.Nombre
        ...
        ";
require_once 'funciones/actualizarcoloquios.php'; 
$Mensaje= '';
$Estilo= 'danger';
              ...
              <table class="table">
               ...
               <input type="hidden"  name="id" value="<?php echo $row['ID']; ?>">
                ...
                <td> <input type="text" style="border:0" name="hora" value="<?php echo $row['Hora']; ?>"></td>
                  ...
                  <td>  <a class="btn btn-secondary" href="listado_coloquios.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Volver</a></td>
                  </tr>
