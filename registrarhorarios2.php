...
require_once 'funciones/listar_listacursotarde.php'; 
$ListadoCurso2=Listar_Listacursostarde($MiConexion);
$CantidadCurso2=count($ListadoCurso2);

require_once 'funciones/listar_horario_ingreso3.php'; 
$ListadoHorario_ingreso=Listar_Horario_ingreso($MiConexion);
$CantidadHorario_ingreso=count($ListadoHorario_ingreso);

require_once 'funciones/listar_horarios_salida3.php'; 
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Ciclo Basico Turno Tarde<img  src= "icon/marching-flute-player-md-nwm-v-unscreen.gif" style="width:10%; position: absolute; right:1%" /></h3>
