...
if(!empty($_POST['BotonRegistrar'])){
 ...
 require_once 'funciones/dni_loguin.php'; 
  $DocenteLogueado=DatosDniLoguin($_POST['NumeroDni'], $MiConexion);
  if(!empty($DocenteLogueado)){
    $_SESSION['Docente_Nombre']=$DocenteLogueado['NOMBRE'];
     $_SESSION['Docente_Apellido']=$DocenteLogueado['APELLIDO'];
      ...
      header('location:Reportes-pdf-php/index.php');
      exit;
    }
    else
      {
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Certificado General Docente</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Inicio</li>
          <li class="breadcrumb-item"><a href="#">Certificado General Docente</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Selecciona el Docente<img  src= "icon/figure-looking-observing-md-nw-unscreen.gif" style="width:15%; position: absolute; right: 8%" /></h3>
...
required>
   ...
   <div class="tile-footer">
    <button class="btn btn-primary" type="submit" name="BotonRegistrar" value="registrar"><i class="fa fa-fw fa-lg fa-check-circle"></i>Generar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="constancia.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
            </div>
            </div>
            </form>
</div>
