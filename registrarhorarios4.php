...
require_once 'funciones/listar_listacursooritarde.php'; 
$ListadoCurso4=Listar_Listacursosoritarde($MiConexion);
$CantidadCurso4=count($ListadoCurso4);
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Ciclo Orientado Turno Tarde<img  src= "icon/marching-major-md-nwm-v2-unscreen.gif" style="width:10%; position: absolute; right:1%" /></h3>
