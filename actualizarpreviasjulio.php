...
$coloquios = "SELECT Id, Curso, Materia, Fecha, Hora
       ...
       where  Id='$variable'
        ";
require_once 'funciones/actualizarpreviasjulio.php'; 
$Mensaje= '';
$Estilo= 'danger';
              ...
              <table class="table">
               ...
               <input type="hidden"  name="id" value="<?php echo $row['Id']; ?>">
                ...
                <td> <input type="text" style="border:0" name="hora" value="<?php echo $row['Hora']; ?>"></td>
                  ...
                  <td>  <a class="btn btn-secondary" href="listadoprevjul.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Volver</a></td>
                  </tr>
