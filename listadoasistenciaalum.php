...
$SQL = "SELECT doc.Id as ID, doc.Apellido, doc.Nombre, doc.IdCurso as Curso,  asis.Fecha, asis.EstadoAsis as Asistencia
        FROM alumnos doc, asistenciaalum asis
        where doc.Id=asis.IdAlumnos
      order by doc.IdCurso, doc.Apellido, doc.Nombre, asis.Fecha
        ";
...
<?php require_once 'user.inc.php'; ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Listado total de asistencia de alumnos</p>
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item active">
            <a href="#">Listado total de asistencia de alumnos</a></li>
          </ul>
      </div>
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Asistencia  de alumnos</h3>
            <div class="table-responsive">
              <table id="docentesTable" class="table">
               ...
               <tbody>
                ...
                <td><a href="actualizaralumnosasis.php?id=<?php echo $row['ID']; ?>">Actualizar datos...</a></td>
                 </tr>
                 <?php } ?>
 ...
 <h4> Total de registros: <?php echo ($row_cnt);?></h4>
            ...
            </div><img  src= "icon/group-dancing-fad-md-nwm-v2-unscreen.gif" style="width:17%; position: absolute; right: 0.2%" />
          </div>
        </div>
...
$chartSQL = "SELECT 
        ...
        FROM alumnos doc
        JOIN asistenciaalum estad ON doc.Id = estad.IdAlumnos
