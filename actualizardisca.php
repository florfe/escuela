...
$variable=$_GET['id'];
$alumnos = "SELECT doc.Id , doc.Apellido, doc.Nombre, doc.IdCurso as Curso, doc.IdDiscapacidad as Discapacidad, doc.IdTurno as Turno, doc.IdDivision as Division
        FROM alumnos doc
...
require_once 'funciones/actualizardisca.php'; 
$Mensaje= '';
$Estilo= 'danger';
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="table-responsive">
              <table class="table">
               ...
               <input type="hidden"  name="id" value="<?php echo $row['Id']; ?>">
                ...
                <td> <input type="text" style="border:0"  name="discapacidad" value="<?php echo $row['Discapacidad']; ?>"></td>
                  ...
                  <td> <button class="btn btn-primary" type="submit" name="BotonRegistrar" value="registrar">Guardar</td>
                    <td>  <a class="btn btn-secondary" href="listadodiscapacidad.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Volver</a></td>
                  </tr>
            ...
            </div><img  src= "icon/stick-figures-help-walker-md-n-unscreen.gif" style="width:15%; position: absolute; right:8%" />
          </div>
        </div></form>
