...
$SQL = "SELECT DISTINCT Id, Nombre, IdCurso, IdDivision, IdTurno   
        FROM  materiasorientado where IdCurso='6' ORDER BY IdCurso, IdDivision, IdTurno, Nombre 
        ";
        $Mensaje= '';
$Estilo= 'danger';
  ...
  <?php require_once 'slidermaterias.php'; ?>
    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Materias 6° Año</h3>
...
<th></th><th></th>
 ...
 <td><a href="actualizarmaterias.php?id=<?php echo $row['Id']; ?>">Actualizar datos...</a></td>
            ...
            </div><img  src= "icon/cool-dog-wagging-tail-md-nwm-v-unscreen.gif" style="width:15%; position: absolute; right: 8%" />
          </div>
        </div>
