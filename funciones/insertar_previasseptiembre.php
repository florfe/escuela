...
$examen = "SELECT * FROM previasseptiembre ";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
 ...
 $mate= $_POST['Materias'];
  $fech= $_POST['Fecha'];
        ...
        $consultaExamenExistente = "SELECT COUNT(*) AS existe FROM previasseptiembre WHERE Curso='$curso' and Materia='$mate' and Fecha = '$fech' ";
    ...
    $SQL_Insert="INSERT INTO previasseptiembre (Curso, Materia, Fecha, Hora, Docente, Docente2, Docente3)
