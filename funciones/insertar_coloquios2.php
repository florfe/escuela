...
$examen = "SELECT * FROM coloquiosdic ";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
 ...
 $hora= $_POST['Hora'];
        ...
        $consultaExamenExistente = "SELECT COUNT(*) AS existe FROM coloquiosdic WHERE Curso='$curso' and Division='$divi' and Turno='$turno' and Materia='$mate' and Fecha = '$fech' and Hora='$hora'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
 ...
 $mate= $_POST['Materias'];
        ...
        // Verificar si la fecha ya está en la base de datos
        $consultaExamenExistente = "SELECT COUNT(*) AS existe FROM coloquiosdic WHERE Curso='$curso' and Division='$divi' and Turno='$turno' and Materia='$mate'  ";
        $resultadoExamenExistente = mysqli_query($vConexion, $consultaExamenExistente);
        $filaExamenExistente = mysqli_fetch_assoc($resultadoExamenExistente);
    ...
    $SQL_Insert="INSERT INTO coloquiosdic (Curso, Division, Turno, Materia, Fecha, Hora, Docente)
