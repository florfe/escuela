...
require_once 'funciones/actualizarcursosCO.php'; 
$Mensaje= '';
$Estilo= 'danger';
if(!empty($_POST['BotonRegistrar'])) {
 ...
 $id = $_POST['id'];
    ...
    $checkSQL = "SELECT COUNT(*) AS count FROM materiasorientado WHERE  IdCurso = '$curso' AND IdDivision = '$divi' AND IdTurno = '$tur'";
              ...
              <table class="table">
               ...
               <td> <input type="text" style="border:0" name="apellido" value="<?php echo $row['Apellido']; ?>"></td>
                ...
                <td> <input type="text" style="border:0; width: 180px" name="materia" value="<?php echo $row['Materia']; ?>"></td>
                  ...
                  <td>  <a class="btn btn-secondary" href="listadocursosori.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Volver</a></td>
                  </tr>
