...
$SQL = "SELECT DISTINCT  Id,  Nombre, IdCurso, IdDivision, IdTurno   
        FROM  materias Where IdCurso='2' ORDER BY IdCurso, IdDivision, IdTurno, Nombre 
        ";
$Mensaje= '';
$Estilo= 'danger';
  ...
  <?php require_once 'slidermaterias.php'; ?>
    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Materias 2° Año</h3>
                               ...
                               <td><?php echo $row['IdCurso']; ?></td>
                                <td><?php echo $row['IdDivision']; ?></td>
                                 <td><?php echo $row['IdTurno']; ?></td>
                                  <td><a href="actualizarmaterias1.php?id=<?php echo $row['Id']; ?>">Actualizar datos...</a></td>
                  <td><a  href="eliminarmaterias.php?id=<?php echo $row['Id']; ?> " class="table_item_link">Eliminar</a></td>
 </tr>
                  <?php }  ?>

                  </tbody>
              </table>
            </div><img  src= "icon/dog-sniffing-footprint-trail-m-unscreen.gif" style="width:20%; position: absolute; right: 8%" />
          </div>
        </div>
