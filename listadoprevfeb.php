...
FROM previas as  col, docentes  as doc 
...
<?php require_once 'user.inc.php'; ?>
  ...
  <?php require_once 'sliderexamen.php'; ?>
    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Previas Febrero</h3>
    ...
    <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <select class="form-control form-control-user" style="width: 20%" name="curso" id="curso" onchange="this.form.submit()">
                                ...
                                <?php
                                $coursesQuery = "SELECT DISTINCT Curso FROM previas";
 ...
 <label for="fecha" class="control-label">Filtrar por Fecha:</label>
  <input class="form-control form-control-user" style="width: 20%" type="date" name="fecha" id="fecha" value="<?php echo $selectedFecha; ?>" min="2023-06-01" max="2023-07-30" onchange="this.form.submit()">
                ...
                <?php
                 ...
                 while($row=mysqli_fetch_assoc($resultado))
                  ...
                  <td><?php echo $row['Curso']; ?></td>
                    ...
                    <td><a href="actualizarprevias.php?id=<?php echo $row['ID']; ?>">Actualizar datos...</a></td>
 ...
 <h4> Total: <?php echo ($row_cnt);?></h4>
            ...
            </div><img  src= "icon/662a1e76a7dbcf33b06914925113e8-unscreen.gif" style="width:15%; position: absolute; right: 8%" />
          </div>
        </div>
        <div class="clearfix"></div>
        
      </div>
       <h3 class="tile-title">Cantidad Total de Previas por Fecha</h3>
 <canvas id="myChart" width="800" height="600"></canvas>
          <?php
$chartQuery = "SELECT Fecha, COUNT(*) as cantidad FROM previas WHERE Fecha <'2023/04/01' GROUP BY Fecha";
