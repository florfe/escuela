...
$ListadoListamaterias=Listar_Listamaterias($MiConexion);
$CantidadListamaterias=count($ListadoListamaterias);
require_once 'funciones/listardocentesciclobasico.php'; 
...
require_once 'funciones/insertar_coloquios.php'; 
...
if(empty($Mensaje)){
  if(InsertarColoquios($MiConexion)!= false) {
 ...
 ?>
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Registrar Coloquios Ciclo Basico</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Ingresa los datos solicitados<img  src= "icon/stick-figure-meditate-float-md-unscreen.gif" style="width:18%; position: absolute; right:15%" /></h3>
...
<?php } ?>
  ...
  <i class="fa fa-asterisk" aria-hidden="true"></i>
  <select name="Materias" class="form-control form-control-user" id="materia">
<option value="" >Selecciona...</option>
...
<?php } ?>
                     ...
                     <div class="col-sm-6 "><label class="control-label">Fecha de Coloquio </label> 
      <i class="fa fa-asterisk" aria-hidden="true"></i>
      <input type="date" id="fecha" class="form-control form-control-user" name="Fecha" min="2023-02-15" max="2023-03-15">
      </div>
      </div>
  ...
  <label class="control-label">Hora de  Coloquio</label> 
...
<?php } ?>
    ...
    <button class="btn btn-primary" type="submit" name="BotonRegistrar" value="registrar"><i class="fa fa-fw fa-lg fa-check-circle"></i>Registrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="coloquioscb.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
            </div>
