...
if(!empty($_POST['BotonRegistrar'])){
 ...
 require_once 'funciones/dni_loguinactafeb.php'; 
  ...
  if(!empty($AlumnoLogueado)){
     ...
     header('location:ReportesActavolanteFebrero-pdf-php/index.php');
      exit;
    }
    else
      {
        $Mensaje='Aún no hay exámenes Coloquio Febrero! Intenta más adelante';
  }
  }
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Acta Volante Coloquio Febrero</h3>
