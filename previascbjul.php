...
require_once 'funciones/insertar_previasjulio.php'; 
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Ingresa los datos solicitados<img  src= "icon/waving-goodbye-oval-sign-PA-md-unscreen.gif" style="width:18%; position: absolute; right:15%" /></h3>
...
<?php } ?>
      ...
      <i class="fa fa-asterisk" aria-hidden="true"></i>
      <input type="date" id="fecha" class="form-control form-control-user" name="Fecha" min="2023-06-30" max="2023-07-30">
      </div></div>
