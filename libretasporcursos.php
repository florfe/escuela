    ...
    $_SESSION['Docente_Nombre']=$DocenteLogueado['NOMBRE'];
     $_SESSION['Docente_Apellido']=$DocenteLogueado['APELLIDO'];
      $_SESSION['Docente_NumeroDni']=$DocenteLogueado['NUMERODNI'];
        $_SESSION['Docente_IdCurso']=$DocenteLogueado['IDCURSO'];
          $_SESSION['Docente_IdDivision']=$DocenteLogueado['IDDIVISION'];
            $_SESSION['Docente_IdTurno']=$DocenteLogueado['IDTURNO'];
              $_SESSION['Docente_Materias']=$DocenteLogueado['MATERIAS'];
 header('location:ReportesLibretasCursos-pdf-php/index.php');
      exit;
    }
    else
      {
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Libretas por cursos</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Inicio</li>
          <li class="breadcrumb-item"><a href="#">Libretas por cursos</a></li>
        </ul>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Ingresa Dni del docente<img  src= "icon/stick-figure-panicking-md-nwm--unscreen.gif" style="width:15%; position: absolute; right: 8%" /></h3>
...
<?php } ?>
   ...
   <div class="tile-footer">
    ...
    <button class="btn btn-primary" type="submit" name="BotonRegistrar" value="registrar"><i class="fa fa-fw fa-lg fa-check-circle"></i>Generar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="libretasporcursos.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
            </div>
            </div>
            </form>
