...
<h1 >Debes seleccionar una opcion.</h1>
   ...
   <section >
      ...
      <img src="img/logo.png" alt="" class="banner2__img"> 
            <a class="button1" title="INGRESA" href="principal.php">ADMINISTRACIÓN DOCENTES</a>
 <img src="icon/7085a448cd78b1a87017901fa80a7a94.gif" alt="" class="seccion1__img"> 
<a class="button2" title="INGRESA" href="principalexamen.php">ADMINISTRACIÓN  EXÁMEN</a>
...
<img src="icon/c3fffbed1207d91467708b02a2713cfc.gif" alt="" class="seccion3__img">
 <a class="button4" title="INGRESA" href="principalalumnos.php">ADMINISTRACIÓN ALUMNOS</a>
