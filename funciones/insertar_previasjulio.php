...
$examen = "SELECT * FROM previasjulio ";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
 ...
 $fech= $_POST['Fecha'];
        ...
        $consultaExamenExistente = "SELECT COUNT(*) AS existe FROM previasjulio WHERE Curso='$curso' and Materia='$mate' and Fecha = '$fech'   ";
    ...
    $SQL_Insert="INSERT INTO previasjulio (Curso, Materia, Fecha, Hora, Docente, Docente2, Docente3)
